...
!rm -rf kmwe_review
!git clone https://github.com/nyh10063/Automatic-Annotation-of-Korean-Grammatical-Items.git kmwe_review
...
처음 실행할 때는 모델 다운로드(16gb)와 로딩에 시간이 걸릴 수 있습니다. T4 기준 6분 정도 예상하시면 되십니다.
